...
def test_runner_prevents_duplicate_drafts_and_marks_persistence_conflicts_failed():
    ...
    assert "isinstance(error, IntegrityError)" in SOURCE
    assert 'return "Document draft persistence conflict"' in SOURCE
